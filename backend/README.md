...
- Utilizar Amaxon SESpara envios em produção;
...
- As notificaçẽos do prestador devem ser enviadas em tempo-real utilizando socket.io;
...
- O usuário deve poder listar horários disponíveis em um dia específico de um prestaador;
